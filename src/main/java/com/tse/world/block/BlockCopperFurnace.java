...
import com.tse.tileentity.TileEntityCopperFurnace;
...
public class BlockCopperFurnace extends BlockContainer
{
    ...
    protected BlockCopperFurnace(boolean isBurning, String name)
    {
        super(Material.ROCK);
    ...
    {
        return Item.getItemFromBlock(BlockManager.copperFurnace);
    }
    ...
    {
    	if (!worldIn.isRemote) {
	        playerIn.openGui(TheStuffExtension.instance, GuiManager.COPPER_FURNACE_GUI, worldIn, pos.getX(), pos.getY(), pos.getZ());
	    }
	    return true;
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityCopperFurnace)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    {
        return new ItemStack(BlockManager.copperFurnace);
    }
