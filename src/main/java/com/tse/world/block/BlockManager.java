...
public class BlockManager {
	...
	public static Item eterniumBlockItem = new ItemBlock(eterniumBlock).setRegistryName("eternium_block")
			.setUnlocalizedName("eternium_block");
	...
	public static void registerBlocks(RegistryEvent.Register<Block> event) {
		...
		registry.registerAll(exaltedDiamondOre, bloodDiamondOre, terraDiamondOre, copperOre, mortiumOre, tinOre,
				...
				vividiumBlock, extranetiumBlock, silverBlock, platinumBlock, titaniumBlock, zincBlock, brassBlock,
				leadBlock, nickelBlock, pewterBlock, aluminumBlock, mnemiumBlock, eterniumBlock, sphaleriteBlock,
	...
	public static void registerItemBlocks(RegistryEvent.Register<Item> event) {
		...
		registry.registerAll(exaltedDiamondOreItem, bloodDiamondOreItem, terraDiamondOreItem, copperOreItem,
				...
				extranetiumBlockItem, silverBlockItem, platinumBlockItem, titaniumBlockItem, zincBlockItem,
				brassBlockItem, leadBlockItem, nickelBlockItem, pewterBlockItem, aluminumBlockItem, mnemiumBlockItem,
				eterniumBlockItem, sphaleriteBlockItem,
