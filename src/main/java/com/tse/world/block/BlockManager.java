...
public class BlockManager {
	...
	public static Block storeBox = new StoreBox("store_box");
	public static Block mysteriousBox = new MysteriousBox("mysterious_box");
	public static Block superStoreBox = new SuperStoreBox("super_store_box");
	public static Block diamondStoreBox = new DiamondStoreBox("diamond_store_box");

	public static Block alloyFurnace = new AlloyFurnace(false, "alloy_furnace");
	public static Block alloyFurnaceActive = new AlloyFurnace(true, "alloy_furnace_active");
	
	public static Block copperAlloyFurnace = new CopperAlloyFurnace(false, "copper_alloy_furnace");
	public static Block copperAlloyFurnaceActive = new CopperAlloyFurnace(true, "copper_alloy_furnace_active");
