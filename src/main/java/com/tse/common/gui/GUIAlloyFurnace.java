...
public class GUIAlloyFurnace extends GuiContainer
{
    ...
    public GUIAlloyFurnace(EntityPlayer playerIn, InventoryPlayer playerInv, TileEntityAlloyFurnace furnaceInv)
    {
        super(new ContainerAlloyFurnace(playerIn, playerInv, furnaceInv));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.mc.getTextureManager().bindTexture(ALLOY_FURNACE_GUI_TEXTURES);
