...
public class BlockAlloyFurnace extends BlockContainer
{
    ...
    protected BlockAlloyFurnace(boolean isBurning, String name)
    {
        super(Material.ROCK);
    ...
    {
    	if (!worldIn.isRemote) {
	        playerIn.openGui(TheStuffExtension.instance, GUIManager.GUI_ALLOY_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
	    }
	    return true;
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, BlockManager.alloyFurnaceActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlockManager.alloyFurnaceActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, BlockManager.alloyFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlockManager.alloyFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new ItemStack(BlockManager.alloyFurnace);
    }
