...
public class BlockSuperStoreBox extends BlockContainer{

	protected BlockSuperStoreBox(String unlocalizedName) {
		super(Material.IRON);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntitySuperStoreBox();
	}
	@Override
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
		if (stack.hasDisplayName()) {
			((TileEntitySuperStoreBox) worldIn.getTileEntity(pos)).setCustomName(stack.getDisplayName());
		}
	}
    ...
    {
		if (!worldIn.isRemote) {
	        playerIn.openGui(TheStuffExtension.instance, GUIManager.GUI_SUPER_STORE_BOX, worldIn, pos.getX(), pos.getY(), pos.getZ());
	    }
	    return true;
	}
