...
public class ChunkProviderMoon implements IChunkGenerator
{
    ...
    public ChunkProviderMoon(World worldIn, long seed, boolean mapFeaturesEnabledIn, String p_i46668_5_)
    {
        {
